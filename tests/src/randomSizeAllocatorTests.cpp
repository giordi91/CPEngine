...
TEST_CASE("Random size allocator simple allocation", "[memory]") {
  ...
  cp::core::RandomSizeAllocator alloc;
  alloc.initialize(256);
  cp::core::RandomSizeAllocationHandle mem = alloc.allocate(16);
  unsigned char *ptr = alloc.getPointer(mem);
...
TEST_CASE("Random size allocator multiple allocations", "[memory]") {
  ...
  cp::core::RandomSizeAllocator alloc;
  alloc.initialize(256);
  cp::core::RandomSizeAllocationHandle mem1 = alloc.allocate(16);
  memset(alloc.getPointer(mem1), 0, mem1.dataSize);
  REQUIRE(alloc.getFreeBlocksCount() == 0);
  cp::core::RandomSizeAllocationHandle mem2 = alloc.allocate(24);
  memset(alloc.getPointer(mem2), 0, mem2.dataSize);
  REQUIRE(alloc.getFreeBlocksCount() == 0);
  cp::core::RandomSizeAllocationHandle mem3 = alloc.allocate(48);
  memset(alloc.getPointer(mem3), 0, mem3.dataSize);
  REQUIRE(alloc.getFreeBlocksCount() == 0);
  cp::core::RandomSizeAllocationHandle mem4 = alloc.allocate(8);
  memset(alloc.getPointer(mem4), 0, mem4.dataSize);
  REQUIRE(alloc.getFreeBlocksCount() == 0);
  cp::core::RandomSizeAllocationHandle mem5 = alloc.allocate(16);
  ...
  unsigned char *mem2ptr = alloc.getPointer(mem2);
  ...
  // memory wise
  cp::core::RandomSizeAllocationHandle newMem2 = alloc.allocate(12);
  REQUIRE(alloc.getPointer(newMem2) == mem2ptr);
  REQUIRE(newMem2.allocSize == 24);
  REQUIRE(newMem2.dataSize == 12);

  // do a couple more de-alloc
  unsigned char *mem3ptr = alloc.getPointer(mem3);
  alloc.freeAllocation(mem3);
  REQUIRE(alloc.getStartPtr() + (112) == alloc.getUnfragmentedPtr());
  unsigned char *mem5ptr = alloc.getPointer(mem5);
  alloc.freeAllocation(mem5);
  REQUIRE(alloc.getStartPtr() + (112) == alloc.getUnfragmentedPtr());
  unsigned char *mem4ptr = alloc.getPointer(mem4);
  alloc.freeAllocation(mem4);
  REQUIRE(alloc.getStartPtr() + (112) == alloc.getUnfragmentedPtr());

  REQUIRE(alloc.getFreeBlocksCount() == 3);
  cp::core::RandomSizeAllocationHandle newMem3 = alloc.allocate(18);
  ...
  cp::core::RandomSizeAllocationHandle newMem5 = alloc.allocate(16);
  ...
  cp::core::RandomSizeAllocationHandle newMem4 = alloc.allocate(12);
